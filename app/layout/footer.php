...
<footer class="footer">    
    <!--
    <svg id="svgfooter" style="pointer-events: none;" class="wavefoo custom" width="100%" height="50px" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1920 75">
        <defs>            
    ...
    <div class="container text-center">        
        <small class="text-white text-capitalize"><?=APP_DESCR?></small>
    </div>
</footer>
